CREATE PROCEDURE [dbo].[spGlobalLookupSelectAllByParentId]
	@Locale nvarchar(10) ='' ,
...
SELECT @IsGlobal=IsGlobal FROM GlobalLookupType WHERE Id = (SELECT GlobalLookupTypeId FROM GlobalLookup WHERE Id =@ParentId)
